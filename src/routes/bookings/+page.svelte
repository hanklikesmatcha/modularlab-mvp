...
<div class="grid grid-col-3 gap-ß4">
	<h1 class="col-start-1 col-end-4 text-3xl font-bold text-center m-8">Bookings</h1>
...
{#if bookings.length === 0 }
    <a class="link link-secondary text-center">No bookings. Let's make a booking</a>
{:else}
    {#each bookings as { id, created_at, suppliers }, i}
        <div class="card w-96 bg-base-100 shadow-xl m-auto">
            <figure class="px-10 pt-10">
                <img src="https://kdsouqliqevajonekxon.supabase.co/storage/v1/object/public/thumbnails-for-suppliers/900fed31-b139-4359-b006-feaa156c1f8f.jpeg" alt="Shoes" class="rounded-xl" />
            </figure>
